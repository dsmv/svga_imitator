...
module  ctrl_bufg_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //ctrl_bufg_altclkctrl_0_sub
...
module  ctrl_bufg_altclkctrl_0  (
    ...
    ctrl_bufg_altclkctrl_0_sub  ctrl_bufg_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
