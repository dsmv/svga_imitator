 ...
 * 	\param	name		key of argument
 * 	\param	defValue	default value for arguments
 * 	\parma  format		format for sscanf
 *
 * 	\return   value of argument or default value of argument
 */
int GetFromCommnadLine(int argc, char **argv, const char* name, int defValue, char *format)
{
    int ret=defValue;
    for( int ii=1; ii<argc-1; ii++ )
    {
